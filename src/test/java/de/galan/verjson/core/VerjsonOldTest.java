 ...
 */
@Ignore
public class VerjsonOldTest extends AbstractTestParent {
	...
	public void v1WriteReadWithoutTransformer() throws Exception {
		...
		assertFileEqualsToString("example1.json", VerjsonOldTest.class, v1String);
	...
	public void v2WriteReadWithTransformer() throws Exception {
		...
		assertFileEqualsToString("example2.json", VerjsonOldTest.class, v2String);
